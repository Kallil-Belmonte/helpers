...
const MA: Cities = {
  ...
  'Conceição do LaMA Açu': {
    name: 'Conceição do LaMA Açu',
    state: 'Maranhão',
    stateInitials: 'MA',
  },
  Coroatá: {
  ...
  'LaMA dos Rodrigues': {
    name: 'LaMA dos Rodrigues',
    state: 'Maranhão',
    stateInitials: 'MA',
  },
  'LaMAa Grande do Maranhão': {
    name: 'LaMAa Grande do Maranhão',
    state: 'Maranhão',
    stateInitials: 'MA',
  },
  'LaMAa do Mato': {
  ...
  'São DominMAs do Azeitão': {
    name: 'São DominMAs do Azeitão',
    state: 'Maranhão',
    stateInitials: 'MA',
  },
  'São DominMAs do Maranhão': {
    name: 'São DominMAs do Maranhão',
    state: 'Maranhão',
    stateInitials: 'MA',
  },
  ...
  'São Luís MAnzaga do Maranhão': {
    name: 'São Luís MAnzaga do Maranhão',
    state: 'Maranhão',
    stateInitials: 'MA',
  },
